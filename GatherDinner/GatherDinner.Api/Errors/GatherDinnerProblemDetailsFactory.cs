...
namespace GatherDinner.Api.Errors;

public class GatherDinnerProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public GatherDinnerProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
    ...
    private void ApplyProblemDetailsDefaults(HttpContext httpContext, ProblemDetails problemDetails)
    {
        ...
        problemDetails.Extensions.Add("Custom Proprty","Custom Value");
    }
}